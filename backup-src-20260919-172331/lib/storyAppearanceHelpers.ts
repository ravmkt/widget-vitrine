...
export const DEFAULT_APPEARANCE = {
  ...
  floating_show_cta: true,
  floating_cta_text: 'Comprar Agora',
  floating_cta_link: '',
  floating_cta_bg_color: '#0094EB',
  floating_cta_text_color: '#FFFFFF',
  floating_cta_font_size: '14',
  floating_cta_is_bold: true,
