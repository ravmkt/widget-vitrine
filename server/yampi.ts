...
if (!YAMPI_ALIAS || !YAMPI_TOKEN || !YAMPI_SECRET_KEY) {
  console.error('[Yampi Proxy] ERRO: Variáveis de ambiente da Yampi não configuradas corretamente no .env.');
}

// URL Base utilizando o Alias da loja
...
app.listen(port, '0.0.0.0', () => {
  console.log(`[Yampi Proxy] Yampi proxy running on port ${port}`);
  console.log(`[Yampi Proxy] Health endpoint available at /api/yampi/health`);
