(function () {
  ...
  function buildSharedCss(appearance) {
    ...
    return (
      ...
      + '.vl-carousel-container{scroll-snap-type:x mandatory!important;}'
      + '.vl-carousel-container.is-dragging{scroll-snap-type:none!important;}'
  ...
  function getFullCSS() {
    ...
    return [
      ...
      '.vl-container { font-family: ' + fontFamily + '; direction: ltr; text-align: left; }',
      ...
      '@media (min-width: 768px) { .vl-modal { height: 90dvh; max-height: 800px; border-radius: 20px; } }',
