(function () {
  ...
  function readComments() {
    ...
    var query = 'comments?select=id,store_id,story_id,video_id,user_name,user_email,content,status,created_at,reply_content,replied_at,reply_status&store_id=eq.' +
  ...
  function openCommentsPanel(videoId, storyId) {
    ...
    if (videoComments.length === 0) {
      ...
      videoComments.forEach(function (c) {
        ...
        authorName.textContent = c.user_name || 'Visitante';
    ...
    statusMsg.style.cssText = 'min-height:16px;text-align:center;font-size:12px;margin-bottom:6px;transition:all 0.2s;';
    ...
    function refreshCommentsList(listEl, vId, pColor) {
      ...
      if (updated.length === 0) {
        ...
        updated.forEach(function (c) {
          ...
          nm.textContent = c.user_name || 'Visitante';
