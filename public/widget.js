 ...
 */
(function () {
  console.log('VIDLYTICS WIDGET CARREGADO - APARÊNCIA VIA widget_appearances - 202607151330');

  var VIDLYTICS_WIDGET_VERSION = 'appearance-widget-appearances-only-202607151330';
