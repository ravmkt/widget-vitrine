(function () {
  var WIDGET_VERSION = '2026.07.24-03';
  ...
  function renderInlineWidget(stories, appearance, format, widgetSelector, widgetPosition) {
    ...
    var shadow = targetDiv.shadowRoot || targetDiv.attachShadow({ mode: 'open' });
      ...
      // CSS totalmente reconstruído para o vídeo não estourar
      ...
      stories.forEach(function (story, index) {
        ...
        // Correção principal: Aplica estilos direto no elemento invés de classe Tailwind
        mediaEl.style.width = '100%';
        mediaEl.style.height = '100%';
        mediaEl.style.objectFit = objectFit;
        mediaEl.style.display = 'block';
        mediaEl.style.borderRadius = cardRadius + 'px';
