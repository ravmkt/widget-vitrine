  ...
  return (
    <div className="min-h-screen bg-[#F7FAFC] pb-20">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <Link to="/stories" className="p-2.5 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-all"><ArrowLeft size={20}/></Link>
            <div>
      ...
      <ConfirmDeleteDialog
        ...
        title={`Excluir ${deleteModal.type === 'location' ? 'Local' : 'Regra'}`}
