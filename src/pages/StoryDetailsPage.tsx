                ...
                <div className="grid gap-4 md:grid-cols-[220px_1fr] md:items-end">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      {CONDITION_TYPES_WITH_VALUE.includes('all_pages') ? null : null}
                      <input type="text" className="min-w-0 flex-1 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-bold outline-none" placeholder="/colecao, /produto/nome-do-produto ou trecho da URL" />
                      <button type="button" className="rounded-full border border-slate-200 bg-white p-2 text-slate-500 shadow-sm hover:border-rose-200 hover:text-rose-500">X</button>
                    </div>
                  </div>
