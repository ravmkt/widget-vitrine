...
const updateDynamicCarouselConfig = (patch: Partial<DynamicCarouselConfig>) => {
  setFormData(prev => {
    ...
    updatedDeviceConfig = {
      ...
      highlight_border_width: updatedDeviceConfig.highlight_border_width ?? updatedDeviceConfig.border_width,
      highlight_border_radius: updatedDeviceConfig.highlight_border_radius ?? updatedDeviceConfig.border_radius,
      highlight_mode: updatedDeviceConfig.highlight_mode ?? (autoHighlight ? 'ring' : 'none'),
      highlight_shadow: updatedDeviceConfig.highlight_shadow ?? updatedDeviceConfig.shadow_enabled ?? false,
