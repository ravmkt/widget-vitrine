...
<FormField label="Cor Preço">
                  ...
                  {/* ── Modal ── */}
                  {activeTab === 'modal' && (
                    <SectionCard title="Configurações do Player / Modal">
                      ...
                      <div className="rounded-xl border border-slate-200/70 bg-slate-50/50 p-3.5 space-y-2.5">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <ToggleSwitch label="Exibir card de produto no rodapé" checked={formData.modal_config.show_product} onChange={e => updateModalConfig({ show_product: e.target.checked })} />
