...
// trecho novo
                  {activeTab === 'carousel' && (
                    <SectionCard title="Configurações do Carrossel" description="Personalize a aparência, dimensões, bordas e exibição de produtos no carrossel.">
                      ...
                      {/* Grupo 1: Layout e Dimensões */}
                      <div className="rounded-xl border border-slate-200/70 bg-slate-50/50 p-4 space-y-4">
                        <h4 className="text-xs font-black uppercase tracking-wider text-slate-500">1. Layout & Dimensões</h4>
                      ...
                      {/* Grupo 2: Bordas e Estilo Visual */}
                      <div className="rounded-xl border border-slate-200/70 bg-slate-50/50 p-4 space-y-4">
                        <h4 className="text-xs font-black uppercase tracking-wider text-slate-500">2. Bordas & Ajustes</h4>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <FormField label="Ajuste Imagem (Object Fit)">
                      ...
                      {/* Grupo 3: Exibição e Botões */}
                      <div className="rounded-xl border border-slate-200/70 bg-slate-50/50 p-4 space-y-3">
                        <h4 className="text-xs font-black uppercase tracking-wider text-slate-500">3. Elementos Visíveis</h4>
                      ...
                      {/* Sub-seção condicional: Card do Produto */}
