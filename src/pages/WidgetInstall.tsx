  ...
  return (
    <div className="max-w-4xl space-y-8 animate-fade-in">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-slate-500 font-medium">Copie o código abaixo e cole no cabeçalho (Head) da sua loja Yampi.</p>
      </div>
      ...
      {isLocal && (
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div className="text-sm text-amber-800">
            ...
            <p className="opacity-80">Detectamos que você está em localhost. Para a Yampi acessar o widget, você deve configurar a variável <code className="bg-amber-100 px-1 rounded">VITE_WIDGET_PUBLIC_URL</code> com seu domínio de produção (ex: Vercel).</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { t: "Configuração Yampi", d: "Vá em Configurações > Scripts e cole no campo de 'Cabeçalho'." },
          { t: "Domínio Seguro", d: "Certifique-se de usar HTTPS para evitar bloqueios de segurança." },
          { t: "Acesso Público", d: "O arquivo widget.js está na pasta /public e é acessível sem login." },
        ].map(f => (
