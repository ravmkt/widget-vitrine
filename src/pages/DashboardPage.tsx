...
import {
  Eye, MousePointerClick, TrendingUp, Heart, MessageCircle, Share2, ShoppingBag, ArrowUpRight, CheckCircle2, HelpCircle, X
} from 'lucide-react';
...
const DashboardPage = () => {
  ...
  const chartData = [
    { name: 'Seg', views: 2400, conv: 400 },
    { name: 'Ter', views: 3200, conv: 600 },
    { name: 'Qua', views: 2800, conv: 500 },
    { name: 'Qui', views: 3900, conv: 800 },
    { name: 'Sex', views: 4800, conv: 1100 },
    { name: 'Sáb', views: 3800, conv: 900 },
    { name: 'Dom', views: 4100, conv: 950 },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
             <div className="bg-white border border-slate-200 rounded-xl px-4 py-2 text-xs font-bold text-slate-600 shadow-sm">
                Últimos 30 dias
             </div>
          </div>
        </div>
