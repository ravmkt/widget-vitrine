...
import { HelpCircle, FileText, X, Check, ArrowRight, Sparkles, TrendingUp, Compass, Eye, MousePointerClick, TrendingUp, TrendingDown, CircleDollarSign, Heart, Trophy, HelpCircle } from 'lucide-react'
...
export function OverviewTab({ timeRange, customFrom, customTo, benchmark }: OverviewTabProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-50 dark:bg-[#0f1220] border border-slate-100 dark:border-white/5 p-5 rounded-3xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
